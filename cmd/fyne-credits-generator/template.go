...
func createCreditsGo(credits []*credit.Credit, pname string) string {
	vars := ""
...
`, c.Name, c.URL, c.FormattedText())
	...
	return fmt.Sprintf(template, credit.Version, pname, vars)
}

var template = `// AUTO-GENERATED: This file is generated by github.com/lusingander/fyne-credits-generator (v%s)
